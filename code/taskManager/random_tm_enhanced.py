...
def load_tasks_from_file():
   ...
   global task_mode #Nicole: Shelly Daten
   ...
   try:
      with open(task_file, 'r', encoding='utf-8') as file:
         with task_lock:
            ...
            num_conn_clients = len(connected_clients) # Nicole geändert
      ...
      with task_lock:
         ...
         while task_list:
            ...
            if target_client in connected_clients:
               ...
               current_timestamp = time.strftime("%Y-%m-%d %H:%M:%S", time.localtime(time.time()))  #Nicole
