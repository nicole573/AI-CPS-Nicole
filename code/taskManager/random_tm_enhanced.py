...
def load_tasks_from_file():
   ...
   global task_num
   global iteration #Nicole: Shelly Daten
   global task_mode
   ...
   iteration += 1 #Nicole Zähler für die Iteration
   task_mode = "random" #Nicole: Shelly Daten
   ...
   try:
      with open(task_file, 'r', encoding='utf-8') as file:
         with task_lock:
            ...
            client.publish("infos/taskcount", str(task_num), qos=1)
            ...
            client.publish("infos/taskmode", task_mode, qos=1)
            print(f"Published task_mode: {task_mode} to infos/taskmode")
      ...
      with task_lock:
         ...
         while task_list:
            ...
            if target_client in connected_clients:
               ...
               client.publish("start_stop/taskWorker", 1, qos=1) # Status=1 cause it starts to distribute tasks #Nicole: direkt nach publish von den tasks!
               ...
               print(f"Sent {number_of_tasks} tasks to {target_client} at {current_timestamp}.") #Nicole
...
def on_message(client, userdata, msg):
   ...
   if topic.startswith("finish/"):
      ...
      if clients_with_tasks == finisher_counter:
         stop_distribution_timestamp = time.time()  # Unix-Zeitstempel
         ...
         duration = stop_distribution_timestamp - start_distribution  # Berechnung der Dauer
